  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#f8f4ee] text-[#4A4A4A]">
      ...
      <div className="flex flex-col gap-3 max-w-md mx-auto w-full px-4 mt-10">
        <button className="w-full h-14 bg-[#4A3A2D] text-white rounded-lg text-lg font-semibold hover:opacity-90 transition flex items-center justify-center">
          Option 1
        </button>
        <button className="w-full h-14 bg-[#4A3A2D] text-white rounded-lg text-lg font-semibold hover:opacity-90 transition flex items-center justify-center">
          Option 2
